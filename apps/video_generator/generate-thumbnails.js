...
const PROMPT_PRESETS = {
  ...
  maths_trig_hand_trick: "A high-impact, vibrant YouTube thumbnail for CBSE Class 10 Maths Trigonometry. Features bold glowing neon text 'NEVER MEMORIZE TRIG TABLE!' and 'LEFT HAND CHEAT CODE 🖐️'. Includes a futuristic 3D glowing hand in the center with neon finger angle tags (0°, 30°, 45°, 60°, 90°), glowing cyan Sin, Cos, and Tan formulas floating around it. Dark obsidian background #0F172A with electric cyan (#0284C7), orange (#EA580C), and magenta (#BE185D) light accents. Highly engaging for students.",
